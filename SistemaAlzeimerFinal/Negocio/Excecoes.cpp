...
void Excecoes::ExcecoesAlterarPaciente(ListaPaciente *lista){
    string nome;
    cout << "Digite o nome do paciente a ser alterado: ";
    cin >> nome;
    lista->alterar(nome);
}
...
void Excecoes::ExcecoesExcluirPaciente(ListaPaciente *lista){
    string nome;
    cout << "Digite o nome do paciente a ser excluido: ";
    cin >> nome;
    lista->deletar(nome);
...
void Excecoes::ExcecoesConsultarPaciente(ListaPaciente *lista){
    string nome;
    cout << "Digite o nome do paciente a ser consultado: ";
    cin >> nome;
    lista->consultar(nome);
}

void Excecoes::ExcecoeesCadastraTratamento(ListaTratamento *tratamento){
    string nome;
    int cod;
    cin >> nome;
    cin >> cod;
    //Tratamento *tratamento = new Tratamento(nome,cod);
}
