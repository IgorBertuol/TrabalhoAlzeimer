...
ListaTratamento *Arquivo::lerArquivoT(){
    ...
    ifstream arquivo("/home/igor/SistemaAlzeimer/Tratamentos.csv");
    //ifstream arquivo(QCoreApplication::applicationDirPath().toStdString() + "/Pacientes.csv");
    if(!arquivo.is_open()){
        cout << "arquivo nao foi aberto!\n";
        return NULL;
    }
...
void Arquivo::escreverArquivoT(ListaTratamento *lista){
    ...
    ofstream arquivo("/home/igor/SistemaAlzeimer/Tratamentos.csv");
    if(!arquivo.is_open()){
        cout << "Arquivo nao foi aberto" << endl;
    }
